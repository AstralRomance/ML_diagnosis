...
#   !!!WARNING уточнить как происходит сортировка при классификации. Сейчас полагаем, что порядок элементов не меняется
#   Т.е. считаем, что каждому, полученному при разбиении, значению кластера соответствует значение координат, полученное на входе.
    @property
